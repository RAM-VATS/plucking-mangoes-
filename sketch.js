...
function setup() {
	...
	mango2=new Mango(855,240,35);
	mango3=new Mango(670,240,35);
	mango4=new Mango(730,230,35);
	mango5=new Mango(710,230,36);
	mango6=new Mango(780,250,35);
	mango7=new Mango(825,270,33);
	mango8=new Mango(880,160,35);
	mango9=new Mango(940,220,35);
	mango10=new Mango(980,245,35);

	attach=new Throw(stones.body,{x:100,y:465});

	treeObj=new tree(775,630);
